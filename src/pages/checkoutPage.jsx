...
function CheckoutPage() {
    const {checkout,checkoutCount,deleteCart,price} = useContext(AppContext);
    return(
                ...
                <div className={"bg-gray-300 w-1/3 p-5 rounded-r-xl"}>
                    ...
                    <div className={"border-t border-white pt-4 mt-4 flex flex-col"}>
                        <div className={"flex justify-between"}>
                            ...
                            <span className={"size-md font-semibold"}>${price}</span>
                        </div>
                        ...
                        <div  className={"my-1 p-2 flex flex-col"}>
                            <span className={"text-left text-md font-bold"}>TOTAL PRICE ${price}</span>
